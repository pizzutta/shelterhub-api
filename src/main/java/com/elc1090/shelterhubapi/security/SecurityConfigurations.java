...
public class SecurityConfigurations {
    ...
    @Autowired
    ShelterHubAuthenticationProvider authenticationProvider;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(POST, "/volunteer-login").permitAll()
                        ...
                        .requestMatchers(POST, "/shelter-transaction").hasRole("ADMIN")
                        .requestMatchers(GET, "/shelter-transaction").hasRole("ADMIN")
                        .requestMatchers(GET, "/shelter-transaction/{id}").hasRole("ADMIN")
